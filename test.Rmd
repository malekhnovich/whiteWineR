...
alcoholBar =  ggplot(data  =redInfo,aes( x  = redInfo$alcohol,
                            fill = redInfo$quality))+geom_bar(color = 'yellow')+
...
geom_bar(color = "red")+xlim(0,8)+xlab("residual Sugar")+ggtitle("Residual Sugar Distribution")
...
geom_bar(color = "pink")+xlab("Sulfer Dioxide Levels")+ xlim(0,150)+
